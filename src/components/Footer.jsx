      ...
      <div className="footer-top">
        ...
        <div className="footer-socials">
          ...
          <a href="#" aria-label="Spotify">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M8 11.8c2.8-1 6.5-.8 9.2.5"></path><path d="M9 15.5c2.1-.7 4.9-.5 7.1.3"></path><path d="M7 8c3.5-1.5 8.2-1.2 12 1"></path></svg>
          </a>
