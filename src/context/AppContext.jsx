...
export const translations = {
  es: {
    ...
    /* ── HERO ── */
    heroEyebrow: "Clases de piano · Online y en vivo",
    heroTitle1: "Aprende piano",
    heroTitle2: "con quien",
    heroTitle3: "vive de tocarlo.",
    heroSub: "Soy Jesús Molina, pianista profesional. Te enseño el mismo método con el que he formado a más de 500 estudiantes — desde tu primera escala hasta tu primera pieza completa, sin atajos vacíos ni teoría de relleno.",
    heroCta1: "Ver planes de curso",
    heroCta2: "Ver cómo enseño",
    heroBubbleTag: "En vivo desde el escenario",
    heroScrollDown: "Desplázate",
    heroStat1Label: "años de carrera",
    heroStat2Label: "alumnos formados",
    heroStat3Label: "rating promedio",
  ...
  en: {
    ...
    /* ── HERO ── */
    heroEyebrow: "Piano lessons · Online & live",
    heroTitle1: "Learn piano",
    heroTitle2: "with someone who",
    heroTitle3: "lives to play it.",
    heroSub: "I'm Jesús Molina, professional pianist. I teach the same method with which I've trained over 500 students — from your first scale to your first complete piece, no empty shortcuts, no filler theory.",
    heroCta1: "See course plans",
    heroCta2: "See how I teach",
    heroBubbleTag: "Live from the stage",
    heroScrollDown: "Scroll",
    heroStat1Label: "years of career",
    heroStat2Label: "students trained",
  ...
  fr: {
    ...
    /* ── HERO ── */
    heroEyebrow: "Cours de piano · En ligne & en direct",
    heroTitle1: "Apprenez le piano",
    heroTitle2: "avec quelqu'un qui",
    heroTitle3: "vit pour en jouer.",
    heroSub: "Je suis Jesús Molina, pianiste professionnel. Je vous enseigne la même méthode avec laquelle j'ai formé plus de 500 élèves — de votre première gamme à votre premier morceau complet, sans raccourcis ni théorie inutile.",
    heroCta1: "Voir les plans de cours",
    heroCta2: "Voir comment j'enseigne",
    heroBubbleTag: "En direct depuis la scène",
    heroScrollDown: "Défiler",
    heroStat1Label: "ans de carrière",
    heroStat2Label: "élèves formés",
    heroStat3Label: "note moyenne",
